...
class Py3status:
    ...
    def window(self):
        ...
        """
        adição de filtro para remoção do nome de alguns apps do title
        além de ficar com o título muito extenso ocupando a barra mesmo em um monitor ultrawide com font em 12
        também remove o texto óbvio dando foco no nome só do conteúdo
        """
        ...
        for item in item_lista:
            window_properties["title"] = window_properties["title"].replace(item, "")
